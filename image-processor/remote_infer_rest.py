...
class ort_v5:
    def __init__(self, image, infer_url, conf_thres, iou_thres, img_size, classes):
    ...
    def __call__(self):
        ...
        try:
            response = requests.post(self.infer_url, json=data, verify=False)
        except:
        ...
        result = f"Image processed in {execution_time:.2f} seconds, inference time {inference_time:.2f} seconds"
